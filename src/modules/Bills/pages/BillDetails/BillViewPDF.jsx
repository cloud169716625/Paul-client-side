              ...
              <div className="flex flex-col text-right">
                <div className="flex flex-col gap-1">
                  <div className="flex justify-end gap-2">
                    <h4 className="text-[#474761] text-[24px] flex items-center">
                      Bill to
                    </h4>
                    <h4 className="text-white text-[24px] flex items-center">
                      <img
                        src={brand.base64Logo}
                        alt=""
                        className="w-12 mr-2 height-12"
                      />
                      Company Name
                    </h4>
                  </div>
                ...
                <div className="flex mt-[40px] justify-end gap-4">
                  <div>
                    <h6 className="text-[#474761] text-[14px]">{t("email")}</h6>
                    <p className="text-[#fff]  text-[14px] mt-[4px]">
